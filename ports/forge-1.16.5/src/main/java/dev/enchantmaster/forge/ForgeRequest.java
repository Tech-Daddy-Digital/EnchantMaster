...
public final class ForgeRequest {
    ...
    public static ForgeRequest fromJson(JsonObject json) {
        ...
        List<StyledText> lore = new ArrayList<StyledText>();
        ...
        List<EnchantEntry> enchantments = new ArrayList<EnchantEntry>();
        ...
        List<AttributeEntry> attributes = new ArrayList<AttributeEntry>();
    ...
    public static final class AttributeEntry {
        ...
        public AttributeEntry(String id, double amount, String operation, String slot) {
            this.id = id;
            this.amount = amount;
